...
export const IconOpenBook: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="M4 7.5c4-1.8 7.5-1.6 11 .7v17c-3.5-2.3-7-2.5-11-.7z" fill="#F2D9A8" stroke="#7A4A1E" strokeWidth="1.6" strokeLinejoin="round" />
    <path d="M28 7.5c-4-1.8-7.5-1.6-11 .7v17c3.5-2.3 7-2.5 11-.7z" fill="#FFF0CE" stroke="#7A4A1E" strokeWidth="1.6" strokeLinejoin="round" />
    <path d="M16 8.2v17" stroke="#7A4A1E" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M7 12h5M7 15.5h5M20 12h5M20 15.5h5" stroke="#C9873A" strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);

export const IconHeartBook: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <rect x="6" y="5" width="20" height="22" rx="3" fill="#F2D9A8" stroke="#7A4A1E" strokeWidth="1.6" />
    <rect x="6" y="5" width="5" height="22" rx="2" fill="#C9873A" stroke="#7A4A1E" strokeWidth="1.4" />
...
export const IconQuill: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="M26 5c-9 .5-15 5-16.5 12.5L7 24l6.4-2.6C21 19.6 25.4 13.8 26 5z" fill="#EBD6AE" stroke="#7A4A1E" strokeWidth="1.6" strokeLinejoin="round" />
    <path d="M22 9c-4.5 2.2-8.2 5.8-10.6 10.6" stroke="#C9873A" strokeWidth="1.4" strokeLinecap="round" />
    <path d="M8.5 22.5 5 27" stroke="#7A4A1E" strokeWidth="2" strokeLinecap="round" />
  </svg>
);

export const IconLantern: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="M16 3v3" stroke="#7A4A1E" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M10 9h12l-2 12H12z" fill="#FFD980" stroke="#7A4A1E" strokeWidth="1.6" strokeLinejoin="round" />
    <rect x="8.5" y="6.5" width="15" height="3" rx="1.4" fill="#C9873A" stroke="#7A4A1E" strokeWidth="1.4" />
    <rect x="11" y="21" width="10" height="3" rx="1.4" fill="#C9873A" stroke="#7A4A1E" strokeWidth="1.4" />
    ...
    <path d="M16 24v4" stroke="#7A4A1E" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);

export const IconTeaCup: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="M6 12h16v7a7 7 0 0 1-7 7h-2a7 7 0 0 1-7-7z" fill="#F2D9A8" stroke="#7A4A1E" strokeWidth="1.6" strokeLinejoin="round" />
    <path d="M22 14h2.5a3.5 3.5 0 0 1 0 7H22" fill="none" stroke="#7A4A1E" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M6 18h16" stroke="#C9873A" strokeWidth="1.3" />
    <path d="M11 8c1-1.2 1-2.3 0-3.5M15 8c1-1.2 1-2.3 0-3.5M19 8c1-1.2 1-2.3 0-3.5" stroke="#C9873A" strokeWidth="1.3" strokeLinecap="round" />
  </svg>
);
...
export const IconMedal: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="m11 3 4 8M21 3l-4 8" stroke="#C9873A" strokeWidth="2.4" strokeLinecap="round" />
    <circle cx="16" cy="19" r="8" fill="#FFD980" stroke="#7A4A1E" strokeWidth="1.7" />
    <circle cx="16" cy="19" r="4.6" fill="#FFF3C4" stroke="#C9873A" strokeWidth="1.2" />
    <path d="m16 16 .9 1.9 2.1.3-1.5 1.5.4 2.1-1.9-1-1.9 1 .4-2.1-1.5-1.5 2.1-.3z" fill="#C9873A" />
  </svg>
);

export const IconStarInk: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="m16 4 3.3 7.4 8 .8-6 5.4 1.7 7.9L16 21.4 8.9 25.5l1.8-7.9-6-5.4 8-.8z" fill="#FFD980" stroke="#7A4A1E" strokeWidth="1.6" strokeLinejoin="round" />
...
export const IconHandsThanks: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 32 32" className={className ?? base} aria-hidden>
    <path d="M15 27c-3.6 0-6.5-2.6-6.5-6V11c0-1 .8-1.8 1.7-1.8s1.8.8 1.8 1.8v4L15 4.8c.2-1 1-1.6 1.9-1.4.9.2 1.4 1 1.3 2L15 27z" fill="#F2D9A8" stroke="#7A4A1E" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M17 27c3.6 0 6.5-2.6 6.5-6V11c0-1-.8-1.8-1.7-1.8s-1.8.8-1.8 1.8v4L17 4.8c-.2-1-1-1.6-1.9-1.4-.9.2-1.4 1-1.3 2L17 27z" fill="#FFF0CE" stroke="#7A4A1E" strokeWidth="1.5" strokeLinejoin="round" />
  </svg>
);
