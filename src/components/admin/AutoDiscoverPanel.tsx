...
const AutoDiscoverPanel: React.FC = () => {
  ...
  const toggleEnabled = async (checked: boolean) => {
    ...
    toast({
      ...
      description: checked
        ? 'سيستمر النظام في جلب الكتب بلا توقف ويتنقّل تلقائياً بين تصنيفات Archive.org عند انتهاء كل تصنيف.'
        ...
        <Alert>
          ...
          <AlertDescription className="space-y-1">
            ...
            <ul className="list-disc pr-5 text-sm space-y-0.5">
              ...
              <li>التنقّل التلقائي بين التصنيفات: روايات، قصص، شعر، تاريخ، فلسفة، فقه، تفسير، علوم، أطفال، تراث وغيرها.</li>
